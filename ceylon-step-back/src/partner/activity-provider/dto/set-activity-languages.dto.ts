...
export class ActivityLanguageEntryDto {
...
export class SetActivityLanguagesDto {
  @ApiProperty({ type: [ActivityLanguageEntryDto] })
  @IsArray()
  @ArrayMaxSize(20)
  @ValidateNested({ each: true })
  @Type(() => ActivityLanguageEntryDto)
  languages!: ActivityLanguageEntryDto[];
}

...
function PartnerCard({
  ...
  const cardClassName = cn(
    ...
    !disabled &&
      "hover:-translate-y-0.5 hover:shadow-[0_26px_75px_-55px_rgba(0,0,0,0.45)]",
    isDark
...
function GuideApplicationStatus({
  appStatus,
}: {
  appStatus: {
    status: string;
  ...
  const config = {
    PENDING: {
      ...
      message:
        "We received your application. Our team will get back to you by email once the review is complete. You can't submit another guide application while this one is pending.",
    ...
    APPROVED: {
      ...
      message:
        "Your guide application has been approved. You can manage your profile and services from the dashboard.",
      cta: "View application",
      icon: CheckCircle2,
    },
    REJECTED: {
  ...
  return (
    <div
      className={cn(
        "mt-8 rounded-3xl p-5 ring-1 sm:p-6",
        toneClasses.bg,
        toneClasses.ring,
      )}
    >
      <div className="flex flex-col items-start gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex items-start gap-4">
          ...
          <div>
            <div
              className={cn("text-base font-semibold", toneClasses.titleText)}
            >
              {c.title}
            </div>
    ...
    <div className="min-h-dvh w-full overflow-x-hidden bg-[radial-gradient(1100px_circle_at_15%_10%,rgba(59,130,246,0.16),transparent_45%),radial-gradient(900px_circle_at_85%_20%,rgba(99,102,241,0.12),transparent_40%),linear-gradient(to_bottom,white,rgba(244,244,245,0.9))] p-4 sm:p-6">
      <div className="mx-auto w-full max-w-7xl">
        <div className="overflow-hidden rounded-4xl bg-white/70 shadow-[0_40px_120px_-70px_rgba(0,0,0,0.6)] ring-1 ring-zinc-200/70 backdrop-blur-xl">
          <div className="grid grid-cols-1 gap-10 p-7 sm:p-10 lg:grid-cols-12 lg:gap-12">
            <div className="lg:col-span-7">
              ...
              <p className="mt-4 max-w-2xl text-pretty text-sm leading-6 text-zinc-600 sm:text-base">
                Join our trusted network of Sri Lanka travel partners. Get
                discovered by travelers, receive verified leads, and manage
                enquiries in one place — while you focus on delivering
              ...
              <div className="mt-8 flex flex-wrap items-center gap-3">
                ...
                <Button
                  asChild
                  variant="outline"
                  className="h-11 rounded-full border-zinc-200 bg-white px-6"
                >
              ...
              <div className="relative h-full overflow-hidden rounded-4xl bg-zinc-950 p-8 text-white">
                ...
                <div className="relative">
                  ...
                  <p className="mt-3 text-sm leading-6 text-white/75">
                    Upload photos, list your services, set availability, and
                    respond to enquiries quickly. We help you stand out with a
                    clean listing and clear call-to-actions.
                  </p>
                  ...
                  <div className="mt-6 space-y-3">
                    {[
                      ...
                      <div
                        key={t}
                        className="flex items-start gap-3 rounded-2xl bg-white/10 p-3 ring-1 ring-white/10"
                      >
          ...
          <div
            id="partner-types"
            className="border-t border-zinc-200/70 bg-white/40 p-7 sm:p-10"
          >
            <div className="flex items-end justify-between gap-6">
              <div>
                ...
                <div className="mt-2 text-sm leading-6 text-zinc-600">
                  Pick the category that matches your business. You can add more
                  later.
                </div>
              </div>
            </div>
            ...
            <div className="mt-7 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
              <PartnerCard
                ...
                description={
                  isApprovedGuide
                    ? "You are already a verified guide partner."
                    : isPendingGuide
                      ? "Your application is currently under review."
                      : "Create your guide profile, regions, languages, and packages."
                }
                href="/partner/guide"
                icon={Compass}
                tone="dark"
            ...
            {transportStatus &&
              (transportStatus.status === "PENDING" ||
                transportStatus.status === "APPROVED" ||
                transportStatus.status === "REJECTED") && (
            ...
            {activityStatus &&
              (activityStatus.status === "PENDING" ||
                ...
                activityStatus.status === "REJECTED") && (
            ...
            <div className="mt-8 rounded-3xl bg-white/70 p-5 ring-1 ring-zinc-200/70">
              ...
              <p className="mt-1 text-sm leading-6 text-zinc-600">
                If you offer multiple services (for example, guide + transport),
                choose the closest match now — you can add more categories after
                onboarding.
              </p>
            </div>
          </div>
